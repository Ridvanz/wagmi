...
<nav class="bg-white border-gray-200 dark:bg-gray-900 h-full">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-2">
        <a href="https://flowbite.com" class="flex items-center space-x-3 rtl:space-x-reverse">
          <div
          class=" flex items-center bg-gradient-to-br from-secondary-200 to-primary-100 rounded-md pl-2 pr-2"
        >
          <img src={pik} class="h-12" alt="Flowbite Logo" />
        </div>
        </a>
        <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
            <a href="#" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-500 focus:outline-none dark:focus:ring-gray-800">Login</a>
