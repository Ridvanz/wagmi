...
<nav class="h-full w-full bg-white">
	<div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-3">
		...
		<div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
			<a
				href="#"
				class="text-tertiary dark:text-tertiary hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-500 focus:outline-none dark:focus:ring-gray-800"
				>Login</a
			>
			<a
				href="#"
				class="text-white bg-primary-500 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-500"
				>Sign up</a
			>
			<button
				data-collapse-toggle="mega-menu-icons"
				type="button"
				class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-tertiary rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
		...
		>
			...
			>
				<li>
					<a
						href="#"
						class="block py-2 px-3 text-primary-500 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-primary-300 md:p-0 dark:text-primary-500 md:dark:hover:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-primary-500 md:dark:hover:bg-transparent dark:border-gray-700"
				...
				<li>
					<button
						...
						class="flex items-center justify-between w-full py-2 px-3 font-medium text-tertiary border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-primary-600 md:p-0 dark:text-tertiary md:dark:hover:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-primary-500 md:dark:hover:bg-transparent dark:border-gray-700"
					>
						Company
						<svg
					...
					>
						<div class="p-4 pb-0 text-tertiary md:pb-4 dark:text-tertiary">
							<ul class="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">
								<li>
									...
									>
										...
										<svg
											class="w-3 h-3 me-2 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-500"
											aria-hidden="true"
											xmlns="http://www.w3.org/2000/svg"
											fill="currentColor"
											viewBox="0 0 20 20"
						...
						<div class="p-4 pb-0 text-teriary md:pb-4 dark:text-tertiary">
							<ul class="space-y-4">
								<li>
									<a
										href="#"
						...
						<div class="p-4 text-gray-100 dark:text-tertiary">
							<ul class="space-y-4">
								<li>
									<a
										href="#"
				...
				<li>
					<a
						href="#"
						class="block py-2 px-3 text-tertiary border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-primary-600 md:p-0 dark:text-tertiary md:dark:hover:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-primary-500 md:dark:hover:bg-transparent dark:border-gray-700"
						>Team</a
					>
				</li>
			</ul>
